 ...
 */
class SecurityHTTSRule extends AbstractRule
{
    public static $name = 'SecurityHTTS';
    public static $title = 'HTTP Strict Transport Security (HSTS)';
    public static $description = 'Force client-side SSL redirection.
#
